    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.view}>
                    <TouchableOpacity style={styles.botom} onPress={() => navigation.navigate('CriarCategoria')}>
                        <Text style={styles.txt}>Criar</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.view}>
                <TouchableOpacity style={styles.botom} onPress={() => navigation.navigate('PesEDeltCategoria')}>
